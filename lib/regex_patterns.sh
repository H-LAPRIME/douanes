...
DANGEROUS_PATTERNS["base64[[:space:]]+-d[^|]*\|"]="Décodage base64 puis exécution|8"
...
DANGEROUS_PATTERNS["chmod[[:space:]]+(777|a\+rwx)[[:space:]]+/"]="Permissions globales dangereuses|7"
...
DANGEROUS_PATTERNS["(shutdown|reboot|halt|poweroff)[[:space:]]"]="Arrêt ou redémarrage système|8"
